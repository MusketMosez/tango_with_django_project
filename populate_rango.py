...
def populate():
    ...
    django_pages = [
        {"title":"Official Django Tutorial",
         "url":"https://docs.djangoproject.com/en/1.9/intro/tutorial01/","views": 128, "likes":64},
        {"title":"Django Rocks",
    ...
    other_pages = [
        {"title":"Bottle",
         "url":"http://bottlepy.org/docs/dev/", "views":16, "likes":8},
        {"title":"Flask",
         "url":"http://flask.poco.org", "views":8, "likes":4}]
